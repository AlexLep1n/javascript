...
function showCategory(category) {
    let categoryOfProducts = products[category];
    let markupProducts = '';
    categoryOfProducts.forEach(function (product) {
        markupProducts += getProductMarkup(product);
    });
    divEl.insertAdjacentHTML('afterbegin', markupProducts);
}
